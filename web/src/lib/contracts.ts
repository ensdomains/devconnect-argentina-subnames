...
export const REGISTRY = {
  address: '0xd6a7dcdee200fa37f149323c0ad6b3698aa0e829',
  abi: [
    ...
    {
      inputs: [{ internalType: 'bytes', name: '_name', type: 'bytes' }],
      name: 'decodeName',
    ...
    },
    {
      inputs: [{ internalType: 'bytes32', name: 'node', type: 'bytes32' }],
      name: 'names',
      outputs: [{ internalType: 'bytes', name: 'name', type: 'bytes' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
...
export const REGISTRAR = {
  ...
  abi: [
    ...
    {
      inputs: [{ internalType: 'bytes32', name: 'labelHash', type: 'bytes32' }],
      name: 'NotAvailable',
      type: 'error',
    },
    {
